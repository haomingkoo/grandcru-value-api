        ...
        <tr class="deal-row">
          <td>
            ...
            <div class="wine-links">
              ...
              ${actionLink(deal.grand_cru_url, "Compare Grand Cru")}
              ${actionLink(deal.vivino_url, "See Vivino")}
              ${actionLink(deal.market_retailer_url, deal.market_retailer_name ? `See ${deal.market_retailer_name}` : "")}
            </div>
          </td>
          <td>
          ...
          <td>
            <div class="price-stack">
              ...
              ${deal.vivino_price ? `<div class="price-line"><span class="price-label muted">Vivino</span><span class="muted">${formatMoney(deal.vivino_price)}</span></div>` : ""}
              ${deal.price_market ? `<div class="price-line"><span class="price-label muted">${escapeHtml(deal.market_retailer_name || "Market")}</span><span class="muted">${formatMoney(deal.price_market)}</span></div>` : ""}
            </div>
