      ...
      return `
        <article class="pick-card">
          ...
          <div class="price-stack">
            ...
            ${deal.price_market ? `<div class="price-line" title="Wine-Searcher global average price per 750ml, scaled to match this listing's quantity/volume. Updated weekly."><span class="price-label muted">Global avg</span><span class="muted">${formatMoney(deal.price_market)}</span> ${perUnitNote(deal.price_market, deal)}</div>` : ""}
          </div>
          <div class="pick-meta">
